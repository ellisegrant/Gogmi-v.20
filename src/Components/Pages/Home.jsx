  ...
  return (
    <div className="w-full overflow-x-hidden scroll-smooth">
      ...
      <header className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto max-w-6xl px-6 py-20 flex flex-col items-center text-center text-[#F5F7FA]">
          <div className="inline-flex items-center gap-3 bg-[#C1A875]/20 backdrop-blur-md px-5 py-2 rounded-full border border-[#C1A875]/40 mb-6 animate-fade-in shadow-lg shadow-[#C1A875]/10">
            <span className="w-2 h-2 bg-[#C1A875] rounded-full animate-pulse shadow-lg shadow-[#C1A875]/50"></span>
            <span className="text-[#F5F7FA] font-semibold text-sm drop-shadow-lg" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
              Leading Maritime Future in the Gulf of Guinea
            </span>
          </div>

          <h1 className="hero-heading" style={{ fontFamily: "'Playfair Display', serif" }}>
            <span className="block mb-3 text-[#F5F7FA]">
              Shaping Maritime Security and Safety in the
            </span>
            <span className="block" style={{ 
              background: 'linear-gradient(120deg, #C1A875 0%, #F5F7FA 50%, #C1A875 100%)',
          ...
          <p className="hero-subheading mt-6 text-[#F5F7FA] max-w-3xl leading-relaxed" style={{ fontFamily: "'Source Sans Pro', sans-serif", textShadow: '0 2px 15px rgba(0, 0, 0, 0.9), 0 0 30px rgba(0, 0, 0, 0.6)' }}>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-5 justify-center items-center">
            <Link
              to="/about"
              className="inline-flex items-center gap-3 bg-[#C1A875] text-[#132552] px-8 md:px-10 py-4 rounded-xl font-bold hover:bg-[#7A4E3A] hover:text-[#F5F7FA] transition-all shadow-2xl hover:shadow-[#C1A875]/50 hover:scale-105"
        ...
        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-20">
          <a href="#stats" aria-label="Scroll to stats">
            <ChevronDown className="w-10 h-10 text-[#F5F7FA]/70 animate-bounce" />
          </a>
        </div>
      </header>
        ...
        <div className="container mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={idx}
                className="bg-[#F5F7FA] rounded-2xl p-6 md:p-8 shadow-lg transform hover:-translate-y-2 transition cursor-default flex flex-col items-center text-center"
              >
                <div className="text-#C1A875 mb-3">{stat.icon}</div>
                <div className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-#132552">{stat.number}</div>
                <p className="text-#1F2933 mt-2 font-medium">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <span className="text-[#C1A875] font-semibold text-sm uppercase tracking-wider" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>Who We Are</span>
              <h2 className="text-4xl md:text-5xl font-bold text-[#132552] leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
                Driving Maritime Excellence in West Africa
              </h2>
              <p className="text-[#1F2933] text-lg leading-relaxed" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
              ...
              <Link
                to="/about"
                className="inline-flex items-center gap-2 text-[#7A4E3A] font-bold hover:gap-4 transition-all text-lg"
                style={{ fontFamily: "'Source Sans Pro', sans-serif" }}
              >
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-6">
                <div className="bg-blue-50 rounded-2xl p-6 hover:shadow-lg transition">
                  <Ship className="w-12 h-12 text-#132552 mb-4" />
                  <h3 className="text-xl font-bold text-#132552 mb-2">Advocacy</h3>
                ...
                <div className="bg-yellow-50 rounded-2xl p-6 hover:shadow-lg transition">
                  <TrendingUp className="w-12 h-12 text-#7A4E3A mb-4" />
                  <h3 className="text-xl font-bold text-#132552 mb-2">Capacity Building</h3>
                  <p className="text-#1F2933">
              ...
              <div className="space-y-6 mt-12">
                <div className="bg-green-50 rounded-2xl p-6 hover:shadow-lg transition">
                  ...
                  <h3 className="text-xl font-bold text-#132552 mb-2">Research</h3>
                  <p className="text-#1F2933">
                ...
                <div className="bg-purple-50 rounded-2xl p-6 hover:shadow-lg transition">
                  ...
                  <h3 className="text-xl font-bold text-#132552 mb-2">Secretariate Services</h3>
                  <p className="text-#1F2933">
      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-[#132552] to-[#1A336C] relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-5">
          <div className="absolute w-96 h-96 bg-[#C1A875] rounded-full blur-3xl -top-48 -left-48"></div>
          <div className="absolute w-96 h-96 bg-[#4B637F] rounded-full blur-3xl -bottom-48 -right-48"></div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start mb-8">
            ...
            <div className="relative group">
              ...
              <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                ...
                {/* Label Overlay */}
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#132552]/95 to-transparent p-6">
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-[#C1A875] rounded-full animate-pulse"></div>
                    <div>
                      <p className="text-xs text-[#F5F7FA]/90 uppercase tracking-wide" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>Maritime Region</p>
                      <p className="text-2xl font-bold text-[#F5F7FA]" style={{ fontFamily: "'Playfair Display', serif" }}>Gulf of Guinea</p>
                    </div>
                  </div>
                </div>

                {/* Top Badge */}
                <div className="absolute top-6 right-6 bg-[#C1A875] text-[#132552] px-5 py-2 rounded-full text-sm font-bold shadow-lg" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
                  West & Central Africa
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              {/* Title */}
              <div>
                <h2 className="text-5xl md:text-6xl font-bold text-[#F5F7FA] mb-4 tracking-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
                  The Gulf of Guinea
                </h2>
              </div>

              {/* Description */}
              <div className="space-y-6 text-[#F5F7FA]/90 text-lg leading-relaxed" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
                <p className="text-xl leading-relaxed">
                  A pivotal maritime region stretching along the Atlantic coastline from Senegal to Angola. This strategic waterway serves as a critical gateway for international trade, connecting <strong className="text-[#C1A875]">eighteen coastal nations</strong> to the global economy.
                </p>
          ...
          <div className="mt-16">
            ...
            <div className="text-center mb-8">
              <h3 className="text-3xl md:text-4xl font-bold text-[#F5F7FA] mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
                18 Countries of the Gulf of Guinea
              </h3>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 lg:grid-cols-9 gap-3">
                {[
                  ...
                  <div
                    key={idx}
                    className="group bg-[#F5F7FA]/10 backdrop-blur-sm rounded-xl border-2 border-white/20 hover:bg-[#F5F7FA]/20 hover:border-#C1A875 transition-all duration-300 overflow-hidden cursor-pointer"
                  >
                    ...
                    <div className="px-2 pb-3 text-center">
                      <p className="text-[#F5F7FA] font-bold text-xs leading-tight">{country.name}</p>
                    </div>

                    {/* Hover Accent */}
                    <div className="h-1 bg-gradient-to-r from-blue-400 via-#C1A875 to-blue-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                  </div>
                ))}
              </div>
      ...
      <section className="py-24 md:py-32 bg-gradient-to-b from-white to-gray-50">
        <div className="container mx-auto max-w-7xl px-6">
          ...
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-6xl font-bold text-#132552 mb-3 tracking-tight">
              Our Scope Of Work
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              },
              {
                ...
                iconColor: 'text-#7A4E3A',
                iconBg: 'bg-[#F5F7FA]',
                borderColor: 'hover:border-#7A4E3A'
              }
            ].map((service, idx) => (
              <div
                key={idx}
                className={`group relative bg-[#F5F7FA] rounded-2xl p-10 border-2 border-gray-100 ${service.borderColor} transition-all duration-500 hover:shadow-2xl hover:-translate-y-2`}
              >
                {/* Icon - Clean & Minimal */}
                <div className="mb-8">
                ...
                {/* Title */}
                <h3 className="text-2xl font-bold text-#132552 mb-4 leading-tight">
                  {service.title}
                </h3>
          ...
          <div className="text-center mt-16">
            <Link
              to="/services"
              className="inline-flex items-center gap-3 bg-#132552 text-[#F5F7FA] px-10 py-4 rounded-xl font-semibold hover:bg-#1A336C transition-all duration-300 hover:shadow-2xl hover:scale-105 group"
            >
      ...
      <section className="py-20 md:py-28 bg-gradient-to-br from-[#132552] via-[#1A336C] to-[#132552] text-[#F5F7FA] relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl px-6 relative z-10">
          <div className="text-center mb-16">
            <span className="text-[#C1A875] font-semibold text-sm uppercase tracking-wider">Our Impact</span>
            <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6">Contributing to Global Goals</h2>
            <p className="text-[#F5F7FA]/90 text-lg max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <div
                key={idx}
                className="group bg-[#F5F7FA]/10 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/20 hover:bg-[#F5F7FA]/15 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#C1A875]/20"
              >
                {/* SDG Header with Number */}
                <div className={`bg-gradient-to-r ${sdg.color} p-6 relative overflow-hidden`}>
                  <div className="absolute top-0 right-0 text-[#F5F7FA]/10 text-9xl font-bold leading-none">
                    {sdg.number}
                  </div>
                  <div className="relative z-10 flex items-start justify-between">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[#F5F7FA]/90 font-bold text-lg">SDG {sdg.number}</span>
                      </div>
                      <h3 className="text-2xl font-bold text-[#F5F7FA]">{sdg.title}</h3>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 space-y-4">
                  <p className="text-[#F5F7FA]/70 text-sm leading-relaxed italic border-l-2 border-[#C1A875] pl-3">
                    "{sdg.desc}"
                  </p>
                  
                  <div className="pt-4 border-t border-white/10">
                    <p className="text-[#C1A875] font-semibold text-xs uppercase tracking-wider mb-2">
                      GoGMI's Contribution
                    </p>
                    <p className="text-[#F5F7FA]/90 text-sm leading-relaxed">
                      {sdg.impact}
                    </p>
                  </div>
                </div>
                ...
                <div className="h-1 bg-gradient-to-r from-transparent via-[#C1A875] to-transparent transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
              </div>
            ))}
          </div>
          ...
          <div className="text-center mt-16 space-y-6">
            ...
            <Link
              to="/about"
              className="inline-flex items-center gap-2 bg-[#C1A875] text-[#1F2933] px-8 py-4 rounded-xl font-bold hover:bg-[#7A4E3A] transition-all shadow-lg hover:scale-105"
            >
      ...
      <section className="py-20 md:py-28 bg-[#F5F7FA]">
        <div className="container mx-auto max-w-7xl px-6">
          <div className="text-center mb-16">
            <span className="text-[#C1A875] font-semibold text-sm uppercase tracking-wider">Trusted By</span>
            <h2 className="text-4xl md:text-5xl font-bold text-[#132552] mt-4 mb-6">Our Strategic Partners</h2>
            <p className="text-[#1F2933] text-lg max-w-3xl mx-auto">
            ...
            {[
              ...
              <div key={idx} className="flex items-center justify-center p-6 bg-gray-50 rounded-xl hover:bg-blue-50 transition-all hover:shadow-lg group">
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#132552] to-blue-700 rounded-xl flex items-center justify-center text-[#F5F7FA] font-bold text-xs group-hover:scale-110 transition-transform mx-auto mb-2">
                    {partner.initial}
                  </div>
                  <p className="text-xs text-[#1F2933] font-medium">{partner.name}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="text-center mt-12">
            <Link
              to="/Partners"
              className="text-[#132552] font-semibold hover:text-[#7A4E3A] transition-colors inline-flex items-center gap-2"
            >
      ...
      <section className="py-20 md:py-28 bg-gray-50">
        <div className="container mx-auto max-w-7xl px-6">
          <div className="text-center mb-16">
            <span className="text-[#C1A875] font-semibold text-sm uppercase tracking-wider">Stay Informed</span>
            <h2 className="text-4xl md:text-5xl font-bold text-[#132552] mt-4 mb-6">Upcoming Events, News and Update</h2>
            <p className="text-[#1F2933] text-lg max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-[#F5F7FA] rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 group">
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="bg-[#132552] text-[#F5F7FA] px-3 py-1 rounded-full text-xs font-bold">
                      {news.category}
                    </span>
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-[#132552] mb-3 group-hover:text-[#7A4E3A] transition-colors">
                    {news.title}
                  </h3>
                  <p className="text-[#1F2933] mb-4">{news.excerpt}</p>
                  <Link to="/blog" className="text-[#7A4E3A] font-semibold flex items-center hover:gap-3 transition-all">
                    <span>Read More</span>
      ...
      <section className="py-20 md:py-28 bg-gradient-to-br from-blue-50 to-white">
        <div className="container mx-auto max-w-4xl px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-[#132552] mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="bg-[#C1A875] text-[#1F2933] px-10 py-4 rounded-xl font-bold text-lg hover:bg-[#7A4E3A] transition-all shadow-xl hover:scale-105"
            >
              Get Started
            </Link>
            <Link
              to="/about"
              className="border-2 border-[#132552] text-[#132552] px-10 py-4 rounded-xl font-bold text-lg hover:bg-[#132552] hover:text-[#F5F7FA] transition-all"
            >
              Learn More
            </Link>
          </div>
